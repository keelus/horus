...
(function(global, factory) {
  ...
  var Gauge = (function() {
    ...
    return function Gauge(elem, opts) {
      ...
      function updateGauge(theExtension, theValue, frame) {
        var val = getValueInPercentage(theValue, min, limit),
            ...
            flag = angle <= 180 ? 0 : 1;
        if(displayValue) {
          gaugeValueElem.textContent = label.call(opts, theValue) + theExtension;
        }
      ...
      instance = {
        setMaxValue: function(max) {
          limit = max;
          updateGauge(valueExtension, value);
        },
        ...
        setValueAnimated: function(val, duration) {
          ...
          Animation({
            ...
            step: function(val, frame) {
              updateGauge(valueExtension, val, frame);
            }
          });
        },
        getValue: function() {
